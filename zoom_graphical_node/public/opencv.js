    ...
    var cv = function(cv) {
        ...
        function demangle(func) {
            ...
            try {
                ...
                if (HEAP32[status >> 2] === 0 && ret) { return Pointer_stringify(ret) }
        ...
        function integrateWasmJS() {
            ...
            var info = { "global": null, "env": null, "asm2wasm": { "f64-rem": (function(x, y) { return x % y }), "debugger": (function() { debugger }) }, "parent": Module };
            var exports = null;
        ...
        var Browser = {
            mainLoop: {
                ...
                runIter: (function(func) { if (ABORT) return; if (Module["preMainLoop"]) { var preRet = Module["preMainLoop"](); if (preRet === false) { return } } try { func() } catch (e) { if (e instanceof ExitStatus) { return } else { if (e && typeof e === "object" && e.stack) Module.printErr("exception thrown: " + [e, e.stack]); throw e } } if (Module["postMainLoop"]) Module["postMainLoop"]() })
            },
            isFullscreen: false,
            pointerLock: false,
        ...
        var FS = {
            ...
            close: (function(stream) { if (stream.getdents) stream.getdents = null; try { if (stream.stream_ops.close) { stream.stream_ops.close(stream) } } catch (e) { throw e } finally { FS.closeStream(stream.fd) } }),
            llseek: (function(stream, offset, whence) {
            ...
            createDefaultDevices: (function() {
                ...
                } else if (ENVIRONMENT_IS_NODE) { random_device = (function() { return require("crypto")["randomBytes"](1)[0] }) } else { random_device = (function() { return Math.random() * 256 | 0 }) }
        ...
        function __embind_finalize_value_array(rawTupleType) {
            ...
            var elementTypes = elements.map((function(elt) { return elt.getterReturnType })).concat(elements.map((function(elt) { return elt.setterArgumentType })));
            ...
            whenDependentTypesAreResolved([rawTupleType], elementTypes, (function(elementTypes) {
                elements.forEach((function(elt, i) {
                    ...
                    elt.read = (function(ptr) { return getterReturnType["fromWireType"](getter(getterContext, ptr)) });
                ...
                return [{
                    ...
                    "toWireType": (function(destructors, o) { if (elementsLength !== o.length) { throw new TypeError("Incorrect number of tuple elements for " + reg.name + ": expected=" + elementsLength + ", actual=" + o.length) } var ptr = rawConstructor(); for (var i = 0; i < elementsLength; ++i) { elements[i].write(ptr, o[i]) } if (destructors !== null) { destructors.push(rawDestructor, ptr) } return ptr }),
                    "argPackAdvance": 8,
        ...
        function __embind_finalize_value_object(structType) {
            ...
            whenDependentTypesAreResolved([structType], fieldTypes, (function(fieldTypes) {
                ...
                return [{
                    ...
                    "toWireType": (function(destructors, o) { for (var fieldName in fields) { if (!(fieldName in o)) { throw new TypeError("Missing field") } } var ptr = rawConstructor(); for (fieldName in fields) { fields[fieldName].write(ptr, o[fieldName]) } if (destructors !== null) { destructors.push(rawDestructor, ptr) } return ptr }),
                    "argPackAdvance": 8,
                    "readValueFromPointer": simpleReadValueFromPointer,
                    destructorFunction: rawDestructor
                }]
        ...
        function runDestructor(handle) { var $$ = handle.$$; if ($$.smartPtr) { $$.smartPtrType.rawDestructor($$.smartPtr) } else { $$.ptrType.registeredClass.rawDestructor($$.ptr) } }
        ...
        function embind__requireFunction(signature, rawFunction) {
            ...
            if (Module["FUNCTION_TABLE_" + signature] !== undefined) { fp = Module["FUNCTION_TABLE_" + signature][rawFunction] } else if (typeof FUNCTION_TABLE !== "undefined") { fp = FUNCTION_TABLE[rawFunction] } else {
                ...
                if (dc === undefined) { dc = Module["asm"]["dynCall_" + signature.replace(/f/g, "d")]; if (dc === undefined) { throwBindingError("No dynCall invoker for signature: " + signature) } }
                fp = makeDynCaller(dc)
            }
        ...
        function __embind_register_std_string(rawType, name) {
            ...
            registerType(rawType, {
                ...
                "toWireType": (function(destructors, value) {
                    ...
                    var getElement;
                    if (value instanceof Uint8Array) { getElement = getTAElement } else if (value instanceof Uint8ClampedArray) { getElement = getTAElement } else if (value instanceof Int8Array) { getElement = getTAElement } else if (typeof value === "string") { getElement = getStringElement } else { throwBindingError("Cannot pass non-string to std::string") }
        ...
        function __embind_register_value_array(rawType, name, constructorSignature, rawConstructor, destructorSignature, rawDestructor) { tupleRegistrations[rawType] = { name: readLatin1String(name), rawConstructor: embind__requireFunction(constructorSignature, rawConstructor), rawDestructor: embind__requireFunction(destructorSignature, rawDestructor), elements: [] } }
        ...
        function requireHandle(handle) { if (!handle) { throwBindingError("Cannot use deleted val. handle = " + handle) } return emval_handle_array[handle].value }
        ...
        function __emval_lookupTypes(argCount, argTypes, argWireTypes) { var a = new Array(argCount); for (var i = 0; i < argCount; ++i) { a[i] = requireRegisteredType(HEAP32[(argTypes >> 2) + i], "parameter " + i) } return a }
        ...
        function _pthread_key_delete(key) { if (key in PTHREAD_SPECIFIC) { delete PTHREAD_SPECIFIC[key]; return 0 } return ERRNO_CODES.EINVAL }
        ...
        function _strftime(s, maxsize, format, tm) {
            ...
            var EXPANSION_RULES_2 = {
                ...
                "%t": (function() { return "\t" }),
                "%u": (function(date) { var day = new Date(date.tm_year + 1900, date.tm_mon + 1, date.tm_mday, 0, 0, 0, 0); return day.getDay() || 7 }),
                ...
                "%w": (function(date) { var day = new Date(date.tm_year + 1900, date.tm_mon + 1, date.tm_mday, 0, 0, 0, 0); return day.getDay() }),
        ...
        function invoke_di(index, a1) {
            try { return Module["dynCall_di"](index, a1) } catch (e) {
        ...
        function invoke_dii(index, a1, a2) {
            try { return Module["dynCall_dii"](index, a1, a2) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_diiddi(index, a1, a2, a3, a4, a5) {
            try { return Module["dynCall_diiddi"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_diii(index, a1, a2, a3) {
            try { return Module["dynCall_diii"](index, a1, a2, a3) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_diiid(index, a1, a2, a3, a4) {
            try { return Module["dynCall_diiid"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_diiiddi(index, a1, a2, a3, a4, a5, a6) {
            try { return Module["dynCall_diiiddi"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_diiii(index, a1, a2, a3, a4) {
            try { return Module["dynCall_diiii"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_diiiid(index, a1, a2, a3, a4, a5) {
            try { return Module["dynCall_diiiid"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_diiiii(index, a1, a2, a3, a4, a5) {
            try { return Module["dynCall_diiiii"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_diiiiii(index, a1, a2, a3, a4, a5, a6) {
            try { return Module["dynCall_diiiiii"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_diiiiiii(index, a1, a2, a3, a4, a5, a6, a7) {
            try { return Module["dynCall_diiiiiii"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_diiiiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { return Module["dynCall_diiiiiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_fii(index, a1, a2) {
            try { return Module["dynCall_fii"](index, a1, a2) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_fiii(index, a1, a2, a3) {
            try { return Module["dynCall_fiii"](index, a1, a2, a3) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_fiiii(index, a1, a2, a3, a4) {
            try { return Module["dynCall_fiiii"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_fiiiii(index, a1, a2, a3, a4, a5) {
            try { return Module["dynCall_fiiiii"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_i(index) {
            try { return Module["dynCall_i"](index) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iid(index, a1, a2) {
            try { return Module["dynCall_iid"](index, a1, a2) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iidi(index, a1, a2, a3) {
            try { return Module["dynCall_iidi"](index, a1, a2, a3) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiid(index, a1, a2, a3) {
            try { return Module["dynCall_iiid"](index, a1, a2, a3) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiidd(index, a1, a2, a3, a4) {
            try { return Module["dynCall_iiidd"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiidi(index, a1, a2, a3, a4) {
            try { return Module["dynCall_iiidi"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiidii(index, a1, a2, a3, a4, a5) {
            try { return Module["dynCall_iiidii"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiidiii(index, a1, a2, a3, a4, a5, a6) {
            try { return Module["dynCall_iiidiii"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiidiiii(index, a1, a2, a3, a4, a5, a6, a7) {
            try { return Module["dynCall_iiidiiii"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiiid(index, a1, a2, a3, a4) {
            try { return Module["dynCall_iiiid"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiiif(index, a1, a2, a3, a4) {
            try { return Module["dynCall_iiiif"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiiii(index, a1, a2, a3, a4) {
            try { return Module["dynCall_iiiii"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiiiid(index, a1, a2, a3, a4, a5) {
            try { return Module["dynCall_iiiiid"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiiiii(index, a1, a2, a3, a4, a5) {
            try { return Module["dynCall_iiiiii"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiiiiid(index, a1, a2, a3, a4, a5, a6) {
            try { return Module["dynCall_iiiiiid"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiiiiii(index, a1, a2, a3, a4, a5, a6) {
            try { return Module["dynCall_iiiiiii"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiiiiiii(index, a1, a2, a3, a4, a5, a6, a7) {
            try { return Module["dynCall_iiiiiiii"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiiiiiiididiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13) {
            try { return Module["dynCall_iiiiiiiididiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiiiiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { return Module["dynCall_iiiiiiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiiiiiiiiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12) {
            try { return Module["dynCall_iiiiiiiiiiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_iiiiij(index, a1, a2, a3, a4, a5, a6) {
            try { return Module["dynCall_iiiiij"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_ji(index, a1) {
            try { return Module["dynCall_ji"](index, a1) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_jii(index, a1, a2) {
            try { return Module["dynCall_jii"](index, a1, a2) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_jiii(index, a1, a2, a3) {
            try { return Module["dynCall_jiii"](index, a1, a2, a3) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_jiiii(index, a1, a2, a3, a4) {
            try { return Module["dynCall_jiiii"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_vdii(index, a1, a2, a3) {
            try { Module["dynCall_vdii"](index, a1, a2, a3) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_vdiii(index, a1, a2, a3, a4) {
            try { Module["dynCall_vdiii"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_vid(index, a1, a2) {
            try { Module["dynCall_vid"](index, a1, a2) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_vidi(index, a1, a2, a3) {
            try { Module["dynCall_vidi"](index, a1, a2, a3) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_vididdi(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_vididdi"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_vididdii(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_vididdii"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_vidii(index, a1, a2, a3, a4) {
            try { Module["dynCall_vidii"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_vidiii(index, a1, a2, a3, a4, a5) {
            try { Module["dynCall_vidiii"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_vifi(index, a1, a2, a3) {
            try { Module["dynCall_vifi"](index, a1, a2, a3) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viid(index, a1, a2, a3) {
            try { Module["dynCall_viid"](index, a1, a2, a3) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viidd(index, a1, a2, a3, a4) {
            try { Module["dynCall_viidd"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiddi(index, a1, a2, a3, a4, a5) {
            try { Module["dynCall_viiddi"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiddid(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_viiddid"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiddidd(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiddidd"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiddiddd(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiddiddd"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiddidddd(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiddidddd"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiddii(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_viiddii"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiddiii(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiddiii"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viidi(index, a1, a2, a3, a4) {
            try { Module["dynCall_viidi"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viididdi(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viididdi"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viididdii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viididdii"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viididi(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_viididi"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viididii(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viididii"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viidii(index, a1, a2, a3, a4, a5) {
            try { Module["dynCall_viidii"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viidiii(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_viidiii"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viidiiid(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viidiiid"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viidiiii(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viidiiii"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viif(index, a1, a2, a3) {
            try { Module["dynCall_viif"](index, a1, a2, a3) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viii(index, a1, a2, a3) {
            try { Module["dynCall_viii"](index, a1, a2, a3) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiid(index, a1, a2, a3, a4) {
            try { Module["dynCall_viiid"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidd(index, a1, a2, a3, a4, a5) {
            try { Module["dynCall_viiidd"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddd(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_viiiddd"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidddd(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiidddd"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddddi(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiddddi"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddddii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiddddii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidddi(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiidddi"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidddii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiidddii"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidddiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiidddiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidddiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiidddiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddi(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_viiiddi"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddid(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiiddid"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddidd(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiddidd"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddiddd(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiddiddd"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddidddd(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiiddidddd"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddii(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiiddii"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddiii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiddiii"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddiiid(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiddiiid"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiddiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiddiiiid(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiiddiiiid"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidi(index, a1, a2, a3, a4, a5) {
            try { Module["dynCall_viiidi"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiididi(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiididi"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiididii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiididii"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidii(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_viiidii"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidiiddi(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiidiiddi"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidiii(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiidiii"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidiiid(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiidiiid"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidiiii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiidiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiidiiiidi(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiidiiiidi"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiif(index, a1, a2, a3, a4) {
            try { Module["dynCall_viiif"](index, a1, a2, a3, a4) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiid(index, a1, a2, a3, a4, a5) {
            try { Module["dynCall_viiiid"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidd(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_viiiidd"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiddd(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiiiddd"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidddd(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiidddd"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiddddi(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiiddddi"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiddddii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiiiddddii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidddi(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiidddi"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidddii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiidddii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidddiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiiidddiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidddiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) {
            try { Module["dynCall_viiiidddiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiddi(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiiiddi"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiddii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiiddii"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiddiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiiddiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiddiiid(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiiiddiiid"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiddiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiiiddiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiddiiiid(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) {
            try { Module["dynCall_viiiiddiiiid"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidi(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_viiiidi"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidii(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiiidii"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidiid(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiidiid"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidiidd(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiidiidd"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidiiddi(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiiidiiddi"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidiii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiidiii"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiidiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiidiiiidi(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) {
            try { Module["dynCall_viiiidiiiidi"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiif(index, a1, a2, a3, a4, a5) {
            try { Module["dynCall_viiiif"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiid(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_viiiiid"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiidd(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiiiidd"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiddi(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiiiddi"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiidi(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiiiidi"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiidii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiiidii"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiidiid(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiiidiid"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiidiidd(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiiiidiidd"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiidiiddi(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) {
            try { Module["dynCall_viiiiidiiddi"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiidiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiiidiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiidiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiiiidiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiidiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) {
            try { Module["dynCall_viiiiidiiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiid(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiiiiid"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiidd(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiiiidd"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiddi(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiiiiddi"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiidi(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiiiidi"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiidii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiiiidii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiidiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiiiiidiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiidiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) {
            try { Module["dynCall_viiiiiidiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiidiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12) {
            try { Module["dynCall_viiiiiidiiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiii(index, a1, a2, a3, a4, a5, a6, a7) {
            try { Module["dynCall_viiiiiii"](index, a1, a2, a3, a4, a5, a6, a7) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiid(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiiiiid"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiidd(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiiiiidd"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiiddi(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiiiiiiddi"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiidi(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiiiiidi"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
            try { Module["dynCall_viiiiiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9) {
            try { Module["dynCall_viiiiiiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiiiidd(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) {
            try { Module["dynCall_viiiiiiiiidd"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
            try { Module["dynCall_viiiiiiiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiiiiid(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) {
            try { Module["dynCall_viiiiiiiiiid"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiiiiiddi(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13) {
            try { Module["dynCall_viiiiiiiiiiddi"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) {
            try { Module["dynCall_viiiiiiiiiii"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiiiiiiiiid(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12) {
            try { Module["dynCall_viiiiiiiiiiid"](index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiiij(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_viiiij"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viiij(index, a1, a2, a3, a4, a5) {
            try { Module["dynCall_viiij"](index, a1, a2, a3, a4, a5) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        function invoke_viijii(index, a1, a2, a3, a4, a5, a6) {
            try { Module["dynCall_viijii"](index, a1, a2, a3, a4, a5, a6) } catch (e) {
                if (typeof e !== "number" && e !== "longjmp") throw e;
                Module["setThrew"](1, 0)
            }
        }
        ...
        var __GLOBAL__sub_I_bindings_cpp = Module["__GLOBAL__sub_I_bindings_cpp"] = (function() { return Module["asm"]["__GLOBAL__sub_I_bindings_cpp"].apply(null, arguments) });
        ...
        var __GLOBAL__sub_I_descriptor_pb_cc = Module["__GLOBAL__sub_I_descriptor_pb_cc"] = (function() { return Module["asm"]["__GLOBAL__sub_I_descriptor_pb_cc"].apply(null, arguments) });
        ...
        var __GLOBAL__sub_I_function_pb_cc = Module["__GLOBAL__sub_I_function_pb_cc"] = (function() { return Module["asm"]["__GLOBAL__sub_I_function_pb_cc"].apply(null, arguments) });
        ...
        var __GLOBAL__sub_I_histogram_cpp = Module["__GLOBAL__sub_I_histogram_cpp"] = (function() { return Module["asm"]["__GLOBAL__sub_I_histogram_cpp"].apply(null, arguments) });
        var __GLOBAL__sub_I_hog_cpp = Module["__GLOBAL__sub_I_hog_cpp"] = (function() { return Module["asm"]["__GLOBAL__sub_I_hog_cpp"].apply(null, arguments) });
        ...
        var __GLOBAL__sub_I_opencv_caffe_pb_cc = Module["__GLOBAL__sub_I_opencv_caffe_pb_cc"] = (function() { return Module["asm"]["__GLOBAL__sub_I_opencv_caffe_pb_cc"].apply(null, arguments) });
        var __GLOBAL__sub_I_persistence_types_cpp = Module["__GLOBAL__sub_I_persistence_types_cpp"] = (function() { return Module["asm"]["__GLOBAL__sub_I_persistence_types_cpp"].apply(null, arguments) });
        var __GLOBAL__sub_I_prior_box_layer_cpp = Module["__GLOBAL__sub_I_prior_box_layer_cpp"] = (function() { return Module["asm"]["__GLOBAL__sub_I_prior_box_layer_cpp"].apply(null, arguments) });
        ...
        var __GLOBAL__sub_I_system_cpp = Module["__GLOBAL__sub_I_system_cpp"] = (function() { return Module["asm"]["__GLOBAL__sub_I_system_cpp"].apply(null, arguments) });
        var __GLOBAL__sub_I_tensor_pb_cc = Module["__GLOBAL__sub_I_tensor_pb_cc"] = (function() { return Module["asm"]["__GLOBAL__sub_I_tensor_pb_cc"].apply(null, arguments) });
        var __GLOBAL__sub_I_tensor_shape_pb_cc = Module["__GLOBAL__sub_I_tensor_shape_pb_cc"] = (function() { return Module["asm"]["__GLOBAL__sub_I_tensor_shape_pb_cc"].apply(null, arguments) });
        ...
        var __GLOBAL__sub_I_umatrix_cpp = Module["__GLOBAL__sub_I_umatrix_cpp"] = (function() { return Module["asm"]["__GLOBAL__sub_I_umatrix_cpp"].apply(null, arguments) });
        ...
        var _llvm_rint_f64 = Module["_llvm_rint_f64"] = (function() { return Module["asm"]["_llvm_rint_f64"].apply(null, arguments) });
        ...
        var dynCall_diiddi = Module["dynCall_diiddi"] = (function() { return Module["asm"]["dynCall_diiddi"].apply(null, arguments) });
        var dynCall_diii = Module["dynCall_diii"] = (function() { return Module["asm"]["dynCall_diii"].apply(null, arguments) });
        var dynCall_diiid = Module["dynCall_diiid"] = (function() { return Module["asm"]["dynCall_diiid"].apply(null, arguments) });
        var dynCall_diiiddi = Module["dynCall_diiiddi"] = (function() { return Module["asm"]["dynCall_diiiddi"].apply(null, arguments) });
        ...
        var dynCall_diiiiii = Module["dynCall_diiiiii"] = (function() { return Module["asm"]["dynCall_diiiiii"].apply(null, arguments) });
        ...
        var dynCall_iiiid = Module["dynCall_iiiid"] = (function() { return Module["asm"]["dynCall_iiiid"].apply(null, arguments) });
        ...
        var dynCall_vdiii = Module["dynCall_vdiii"] = (function() { return Module["asm"]["dynCall_vdiii"].apply(null, arguments) });
        var dynCall_vi = Module["dynCall_vi"] = (function() { return Module["asm"]["dynCall_vi"].apply(null, arguments) });
        var dynCall_vid = Module["dynCall_vid"] = (function() { return Module["asm"]["dynCall_vid"].apply(null, arguments) });
        var dynCall_vidi = Module["dynCall_vidi"] = (function() { return Module["asm"]["dynCall_vidi"].apply(null, arguments) });
        var dynCall_vididdi = Module["dynCall_vididdi"] = (function() { return Module["asm"]["dynCall_vididdi"].apply(null, arguments) });
        ...
        var dynCall_viiddidd = Module["dynCall_viiddidd"] = (function() { return Module["asm"]["dynCall_viiddidd"].apply(null, arguments) });
        var dynCall_viiddiddd = Module["dynCall_viiddiddd"] = (function() { return Module["asm"]["dynCall_viiddiddd"].apply(null, arguments) });
        var dynCall_viiddidddd = Module["dynCall_viiddidddd"] = (function() { return Module["asm"]["dynCall_viiddidddd"].apply(null, arguments) });
        var dynCall_viiddii = Module["dynCall_viiddii"] = (function() { return Module["asm"]["dynCall_viiddii"].apply(null, arguments) });
        var dynCall_viiddiii = Module["dynCall_viiddiii"] = (function() { return Module["asm"]["dynCall_viiddiii"].apply(null, arguments) });
        var dynCall_viidi = Module["dynCall_viidi"] = (function() { return Module["asm"]["dynCall_viidi"].apply(null, arguments) });
        var dynCall_viididdi = Module["dynCall_viididdi"] = (function() { return Module["asm"]["dynCall_viididdi"].apply(null, arguments) });
        var dynCall_viididdii = Module["dynCall_viididdii"] = (function() { return Module["asm"]["dynCall_viididdii"].apply(null, arguments) });
        var dynCall_viididi = Module["dynCall_viididi"] = (function() { return Module["asm"]["dynCall_viididi"].apply(null, arguments) });
        var dynCall_viididii = Module["dynCall_viididii"] = (function() { return Module["asm"]["dynCall_viididii"].apply(null, arguments) });
        ...
        var dynCall_viiidd = Module["dynCall_viiidd"] = (function() { return Module["asm"]["dynCall_viiidd"].apply(null, arguments) });
        var dynCall_viiiddd = Module["dynCall_viiiddd"] = (function() { return Module["asm"]["dynCall_viiiddd"].apply(null, arguments) });
        var dynCall_viiidddd = Module["dynCall_viiidddd"] = (function() { return Module["asm"]["dynCall_viiidddd"].apply(null, arguments) });
        var dynCall_viiiddddi = Module["dynCall_viiiddddi"] = (function() { return Module["asm"]["dynCall_viiiddddi"].apply(null, arguments) });
        ...
        var dynCall_viiidddiii = Module["dynCall_viiidddiii"] = (function() { return Module["asm"]["dynCall_viiidddiii"].apply(null, arguments) });
        var dynCall_viiidddiiii = Module["dynCall_viiidddiiii"] = (function() { return Module["asm"]["dynCall_viiidddiiii"].apply(null, arguments) });
        ...
        var dynCall_viiiddidd = Module["dynCall_viiiddidd"] = (function() { return Module["asm"]["dynCall_viiiddidd"].apply(null, arguments) });
        var dynCall_viiiddiddd = Module["dynCall_viiiddiddd"] = (function() { return Module["asm"]["dynCall_viiiddiddd"].apply(null, arguments) });
        var dynCall_viiiddidddd = Module["dynCall_viiiddidddd"] = (function() { return Module["asm"]["dynCall_viiiddidddd"].apply(null, arguments) });
        var dynCall_viiiddii = Module["dynCall_viiiddii"] = (function() { return Module["asm"]["dynCall_viiiddii"].apply(null, arguments) });
        ...
        var dynCall_viiiddiiii = Module["dynCall_viiiddiiii"] = (function() { return Module["asm"]["dynCall_viiiddiiii"].apply(null, arguments) });
        var dynCall_viiiddiiiid = Module["dynCall_viiiddiiiid"] = (function() { return Module["asm"]["dynCall_viiiddiiiid"].apply(null, arguments) });
        var dynCall_viiidi = Module["dynCall_viiidi"] = (function() { return Module["asm"]["dynCall_viiidi"].apply(null, arguments) });
        var dynCall_viiididi = Module["dynCall_viiididi"] = (function() { return Module["asm"]["dynCall_viiididi"].apply(null, arguments) });
        var dynCall_viiididii = Module["dynCall_viiididii"] = (function() { return Module["asm"]["dynCall_viiididii"].apply(null, arguments) });
        var dynCall_viiidii = Module["dynCall_viiidii"] = (function() { return Module["asm"]["dynCall_viiidii"].apply(null, arguments) });
        var dynCall_viiidiiddi = Module["dynCall_viiidiiddi"] = (function() { return Module["asm"]["dynCall_viiidiiddi"].apply(null, arguments) });
        ...
        var dynCall_viiidiiiidi = Module["dynCall_viiidiiiidi"] = (function() { return Module["asm"]["dynCall_viiidiiiidi"].apply(null, arguments) });
        ...
        var dynCall_viiiidd = Module["dynCall_viiiidd"] = (function() { return Module["asm"]["dynCall_viiiidd"].apply(null, arguments) });
        ...
        var dynCall_viiiiddddii = Module["dynCall_viiiiddddii"] = (function() { return Module["asm"]["dynCall_viiiiddddii"].apply(null, arguments) });
        var dynCall_viiiidddi = Module["dynCall_viiiidddi"] = (function() { return Module["asm"]["dynCall_viiiidddi"].apply(null, arguments) });
        var dynCall_viiiidddii = Module["dynCall_viiiidddii"] = (function() { return Module["asm"]["dynCall_viiiidddii"].apply(null, arguments) });
        var dynCall_viiiidddiii = Module["dynCall_viiiidddiii"] = (function() { return Module["asm"]["dynCall_viiiidddiii"].apply(null, arguments) });
        var dynCall_viiiidddiiii = Module["dynCall_viiiidddiiii"] = (function() { return Module["asm"]["dynCall_viiiidddiiii"].apply(null, arguments) });
        var dynCall_viiiiddi = Module["dynCall_viiiiddi"] = (function() { return Module["asm"]["dynCall_viiiiddi"].apply(null, arguments) });
        var dynCall_viiiiddii = Module["dynCall_viiiiddii"] = (function() { return Module["asm"]["dynCall_viiiiddii"].apply(null, arguments) });
        var dynCall_viiiiddiii = Module["dynCall_viiiiddiii"] = (function() { return Module["asm"]["dynCall_viiiiddiii"].apply(null, arguments) });
        ...
        var dynCall_viiiidiidd = Module["dynCall_viiiidiidd"] = (function() { return Module["asm"]["dynCall_viiiidiidd"].apply(null, arguments) });
        ...
        var dynCall_viiiidiiii = Module["dynCall_viiiidiiii"] = (function() { return Module["asm"]["dynCall_viiiidiiii"].apply(null, arguments) });
        ...
        var dynCall_viiiiid = Module["dynCall_viiiiid"] = (function() { return Module["asm"]["dynCall_viiiiid"].apply(null, arguments) });
        var dynCall_viiiiidd = Module["dynCall_viiiiidd"] = (function() { return Module["asm"]["dynCall_viiiiidd"].apply(null, arguments) });
        var dynCall_viiiiiddi = Module["dynCall_viiiiiddi"] = (function() { return Module["asm"]["dynCall_viiiiiddi"].apply(null, arguments) });
        var dynCall_viiiiidi = Module["dynCall_viiiiidi"] = (function() { return Module["asm"]["dynCall_viiiiidi"].apply(null, arguments) });
        var dynCall_viiiiidii = Module["dynCall_viiiiidii"] = (function() { return Module["asm"]["dynCall_viiiiidii"].apply(null, arguments) });
        ...
        var dynCall_viiiiidiiddi = Module["dynCall_viiiiidiiddi"] = (function() { return Module["asm"]["dynCall_viiiiidiiddi"].apply(null, arguments) });
        var dynCall_viiiiidiii = Module["dynCall_viiiiidiii"] = (function() { return Module["asm"]["dynCall_viiiiidiii"].apply(null, arguments) });
        var dynCall_viiiiidiiii = Module["dynCall_viiiiidiiii"] = (function() { return Module["asm"]["dynCall_viiiiidiiii"].apply(null, arguments) });
        ...
        var dynCall_viiiiiid = Module["dynCall_viiiiiid"] = (function() { return Module["asm"]["dynCall_viiiiiid"].apply(null, arguments) });
        ...
        var dynCall_viiiiiidiiii = Module["dynCall_viiiiiidiiii"] = (function() { return Module["asm"]["dynCall_viiiiiidiiii"].apply(null, arguments) });
        var dynCall_viiiiiidiiiii = Module["dynCall_viiiiiidiiiii"] = (function() { return Module["asm"]["dynCall_viiiiiidiiiii"].apply(null, arguments) });
        var dynCall_viiiiiii = Module["dynCall_viiiiiii"] = (function() { return Module["asm"]["dynCall_viiiiiii"].apply(null, arguments) });
        var dynCall_viiiiiiid = Module["dynCall_viiiiiiid"] = (function() { return Module["asm"]["dynCall_viiiiiiid"].apply(null, arguments) });
        ...
        var dynCall_viiiiiiidi = Module["dynCall_viiiiiiidi"] = (function() { return Module["asm"]["dynCall_viiiiiiidi"].apply(null, arguments) });
        ...
        var dynCall_viiiiiiiiidd = Module["dynCall_viiiiiiiiidd"] = (function() { return Module["asm"]["dynCall_viiiiiiiiidd"].apply(null, arguments) });
        var dynCall_viiiiiiiiii = Module["dynCall_viiiiiiiiii"] = (function() { return Module["asm"]["dynCall_viiiiiiiiii"].apply(null, arguments) });
        var dynCall_viiiiiiiiiid = Module["dynCall_viiiiiiiiiid"] = (function() { return Module["asm"]["dynCall_viiiiiiiiiid"].apply(null, arguments) });
        ...
        Module["imread"] = (function(imageSource) {
            var img = null;
            if (typeof imageSource === "string") { img = document.getElementById(imageSource) } else { img = imageSource }
            var canvas = null;
            var ctx = null;
            if (img instanceof HTMLImageElement) {
                ...
                canvas = img;
                ctx = canvas.getContext("2d")
            } else { throw new Error("Please input the valid canvas or img id."); return }
            var imgData = ctx.getImageData(0, 0, canvas.width, canvas.height);
            return cv.matFromImageData(imgData)
        });
        Module["imshow"] = (function(canvasSource, mat) {
            var canvas = null;
            if (typeof canvasSource === "string") { canvas = document.getElementById(canvasSource) } else { canvas = canvasSource }
            if (!(canvas instanceof HTMLCanvasElement)) { throw new Error("Please input the valid canvas element or id."); return }
            if (!(mat instanceof cv.Mat)) { throw new Error("Please input the valid cv.Mat instance."); return }
            var img = new cv.Mat;
        ...
        Module["VideoCapture"] = (function(videoSource) {
            var video = null;
            if (typeof videoSource === "string") { video = document.getElementById(videoSource) } else { video = videoSource }
            if (!(video instanceof HTMLVideoElement)) { throw new Error("Please input the valid video element or id."); return }
            var canvas = document.createElement("canvas");
            ...
            this.read = (function(frame) {
                if (!(frame instanceof cv.Mat)) { throw new Error("Please input the valid cv.Mat instance."); return }
                if (frame.type() !== cv.CV_8UC4) { throw new Error("Bad type of input mat: the type should be cv.CV_8UC4."); return }
                if (frame.cols !== video.width || frame.rows !== video.height) { throw new Error("Bad size of input mat: the size should be same as the video."); return }
        ...
        function Rect() {
            switch (arguments.length) {
                case 0:
                    { this.x = 0;this.y = 0;this.width = 0;this.height = 0; break };
                case 1:
                    { var rect = arguments[0];this.x = rect.x;this.y = rect.y;this.width = rect.width;this.height = rect.height; break };
                case 2:
                    { var point = arguments[0]; var size = arguments[1];this.x = point.x;this.y = point.y;this.width = size.width;this.height = size.height; break };
                case 4:
                    { this.x = arguments[0];this.y = arguments[1];this.width = arguments[2];this.height = arguments[3]; break };
                default:
        ...
        function RotatedRect() {
            switch (arguments.length) {
                case 0:
                    { this.center = { x: 0, y: 0 };this.size = { width: 0, height: 0 };this.angle = 0; break };
                case 3:
                    { this.center = arguments[0];this.size = arguments[1];this.angle = arguments[2]; break };
                default:
                    { throw new Error("Invalid arguments") }
            }
        }
        RotatedRect.points = (function(obj) { return Module.rotatedRectPoints(obj) });
        RotatedRect.boundingRect = (function(obj) { return Module.rotatedRectBoundingRect(obj) });
        RotatedRect.boundingRect2f = (function(obj) { return Module.rotatedRectBoundingRect2f(obj) });
        ...
        Scalar.all = (function(v) { return new Scalar(v, v, v, v) });
        Module["Scalar"] = Scalar;

        function MinMaxLoc() {
            switch (arguments.length) {
                case 0:
                    { this.minVal = 0;this.maxVal = 0;this.minLoc = new Point;this.maxLoc = new Point; break };
                case 4:
                    { this.minVal = arguments[0];this.maxVal = arguments[1];this.minLoc = arguments[2];this.maxLoc = arguments[3]; break };
                default:
                    { throw new Error("Invalid arguments") }
            }
        }
        ...
        function Circle() {
            switch (arguments.length) {
                case 0:
                    { this.center = new Point;this.radius = 0; break };
                case 2:
                    { this.center = arguments[0];this.radius = arguments[1]; break };
                default:
                    { throw new Error("Invalid arguments") }
            }
        }
        ...
        function TermCriteria() {
            switch (arguments.length) {
                case 0:
                    { this.type = 0;this.maxCount = 0;this.epsilon = 0; break };
                case 3:
                    { this.type = arguments[0];this.maxCount = arguments[1];this.epsilon = arguments[2]; break };
                default:
                    { throw new Error("Invalid arguments") }
            }
        }
